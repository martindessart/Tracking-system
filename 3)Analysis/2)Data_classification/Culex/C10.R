...
Sti_range<-Sti_range %>% 
  ...
  filter(Trial!=11) %>% 
  filter(Trial!=12) %>% 
  add_row(Trial=5,frameD=12630,frameF=(frameD+74))  %>% 
  add_row(Trial=6,frameD=15690,frameF=(frameD+74)) %>% 
  add_row(Trial=7,frameD=18750,frameF=(frameD+74)) %>% 
  add_row(Trial=8,frameD=21800,frameF=(frameD+74)) %>% 
  add_row(Trial=9,frameD=24880,frameF=(frameD+74)) %>% 
  add_row(Trial=10,frameD=27940,frameF=(frameD+74)) %>% 
  add_row(Trial=11,frameD=31000,frameF=(frameD+74)) %>% 
  add_row(Trial=12,frameD=34060,frameF=(frameD+74)) %>% 
  arrange(Trial)
